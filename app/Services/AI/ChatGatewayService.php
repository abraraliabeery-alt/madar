...
class ChatGatewayService
{
    ...
    {
        // فلتر مبدئي بسيط للتأكد أن السؤال ضمن نطاق المشروع والتطوير والمقاولات في السعودية
...
1. لائحة المكاتب المشاريعية – وزارة الشؤون البلدية والقروية والإسكان.
...
القواعد:
- ركّز إجاباتك على (المشروع + المقاولات + التطوير + الاستثمار في السعودية) قدر الإمكان.
