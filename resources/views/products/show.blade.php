...
@section('title', $product->name ?? 'عرض المنتج')
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3 space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="mr-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:mr-2">المنتجات</a>
                    </div>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="mr-1 text-sm font-medium text-gray-500 md:mr-2">{{ $product->name ?? 'المنتج' }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Product Information -->
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h1 class="text-2xl font-bold text-gray-900 mb-4">{{ $product->name ?? 'اسم المنتج' }}</h1>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                @foreach($product->features as $feature)
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-700">{{ $feature->name ?? 'Feature ' . $feature->id }}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    @if($product->attributeValues && $product->attributeValues->count() > 0)
                        <div class="mb-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">الخصائص</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                @if($product->comments && $product->comments->count() > 0)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">التعليقات ({{ $product->comments->count() }})</h3>
                        <div class="space-y-4">
                        ...
                        @if($product->comments->count() > 5)
                            <div class="mt-4 text-center">
                                <a href="#" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    عرض جميع التعليقات ({{ $product->comments->count() }})
                                </a>
                            </div>
                        @endif
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">معلومات الناشر</h3>
                    ...
                    <div class="space-y-3">
                        ...
                        @else
                            ...
                            <div class="text-center py-4">
                                <p class="text-gray-600 mb-3">سجل دخولك للتفاعل مع المنتج</p>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{ $product->created_at ? $product->created_at->format('d/m/Y') : 'غير محدد' }}</span>
                        </div>

                        <div class="flex justify-between">
                            <span class="text-gray-600">آخر تحديث:</span>
                            <span class="font-medium">{{ $product->updated_at ? $product->updated_at->format('d/m/Y') : 'غير محدد' }}</span>
                        </div>
                        ...
                        @if($product->facility)
                            <div class="flex justify-between">
                                <span class="text-gray-600">المرفق:</span>
                ...
                <!-- Share Product -->
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">مشاركة المنتج</h3>
