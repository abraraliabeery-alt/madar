...
@section('title', $user->name . ' - ' . __('profile.public_title'))
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                @if($primaryRole === 'facility' && $products->count() > 0)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-xl font-semibold text-gray-900">{{ __('profile.products') }}</h2>
                            <a href="#" class="text-blue-600 hover:text-blue-800 text-sm">{{ __('profile.view_all') }}</a>
                        </div>
                ...
                @if($facilities->count() > 0)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-xl font-semibold text-gray-900">{{ __('profile.facilities') }}</h2>
                            <a href="#" class="text-blue-600 hover:text-blue-800 text-sm">{{ __('profile.view_all') }}</a>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($facilities as $facility)
                                <div class="border rounded-lg p-3 hover:shadow-md transition-shadow">
                                    <h3 class="text-xl font-semibold text-gray-900 mb-2">{{ $facility->name ?? 'Facility ' . $facility->id }}</h3>
            ...
            <div class="space-y-6">
                ...
                @if($user->facebook || $user->twitter || $user->instagram || $user->linkedin || $user->whatsapp_number)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('profile.communication_channels') }}</h3>
                        <div class="space-y-3">
                            @if($user->facebook)
                ...
                <!-- Contact Actions -->
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('profile.contact') }} {{ $user->name }}</h3>
                    <div class="space-y-3">
                        @if($user->phone_number)
