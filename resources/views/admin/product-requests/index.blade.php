...
@section('panel_title', 'طلبات العقارات')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0 font-weight-bold">طلبات العقارات</h5>
        <a href="{{ route('admin.product-requests.create') }}" class="btn btn-sm btn-primary">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white border-bottom">
            <h5 class="mb-0 font-weight-bold">فلترة الطلبات</h5>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ route('admin.product-requests.index') }}" class="row g-3">
                <div class="col-md-3">
    ...
    <form id="bulk-form" method="POST" action="{{ route('admin.product-requests.bulk-action') }}">
        @csrf
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('admin.product-requests.show', $req) }}" class="btn btn-sm btn-outline-primary">عرض</a>
                                    <form method="POST" action="{{ route('admin.product-requests.destroy', $req) }}" onsubmit="return confirm('هل تريد حذف هذا الطلب؟')" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="10" class="text-center py-4 text-muted">لا توجد طلبات حالياً.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
