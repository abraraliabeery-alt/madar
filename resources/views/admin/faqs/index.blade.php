...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" data-intro="{{ __('admin.tour.faqs_header_desc') }}" data-step="39">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" data-intro="{{ __('admin.tour.faqs_table_desc') }}" data-step="40">
