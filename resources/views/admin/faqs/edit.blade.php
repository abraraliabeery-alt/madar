        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">تعديل السؤال</h3>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea name="question" id="question" rows="3" 
                                              ...
                                              placeholder="اكتب السؤال هنا..." required>{{ old('question', $faq->question) }}</textarea>
                                    @error('question')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="answer" id="answer" rows="6" 
                                              ...
                                              placeholder="اكتب الإجابة هنا..." required>{{ old('answer', $faq->answer) }}</textarea>
                                    @error('answer')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" id="category" 
                                           ...
                                           placeholder="مثال: عام، تقني، مالي" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="order" id="order" 
                                           ...
                                           placeholder="0" value="{{ old('order', $faq->order) }}" min="0">
                                    @error('order')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
