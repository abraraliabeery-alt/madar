...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" data-intro="{{ __('admin.tour.facilities_create_header_desc') }}" data-step="65">
            <h5 class="mb-0">{{ __('admin.facilities.create') }}</h5>
                ...
                <div class="row g-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="category_id" class="form-label">{{ __('admin.facilities.category') }} <span class="text-danger">*</span></label>
                                            <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id" required>
                                                <option value="">{{ __('admin.facilities.select_category') }}</option>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>{{ __('admin.facilities.save') }}
                        </button>
                    </div>
                </div>
            </form>
