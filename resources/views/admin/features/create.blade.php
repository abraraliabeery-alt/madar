...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" data-intro="{{ __('admin.tour.features_create_header_desc') }}" data-step="67">
            <h5 class="mb-0">{{ __('admin.features.create') }}</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>{{ __('admin.features.save') }}
                        </button>
                    </div>
                </div>
            </form>
