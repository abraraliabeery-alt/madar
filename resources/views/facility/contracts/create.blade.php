...
<div class="w-full px-4 my-6">
    <div class="bg-white rounded-lg shadow-lg">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-2xl font-bold text-gray-800">إضافة عقد جديد</h3>
        ...
        <form method="POST" action="{{ route('facility.contracts.store') }}">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <textarea name="terms_conditions" id="terms_conditions" rows="4" 
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('terms_conditions') border-red-500 @enderror">{{ old('terms_conditions') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="terms_conditions_ar" id="terms_conditions_ar" rows="4" 
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('terms_conditions_ar') border-red-500 @enderror">{{ old('terms_conditions_ar') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <textarea name="renewal_terms" id="renewal_terms" rows="3" 
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('renewal_terms') border-red-500 @enderror">{{ old('renewal_terms') }}</textarea>
                            @error('renewal_terms')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="termination_terms" id="termination_terms" rows="3" 
                                      class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('termination_terms') border-red-500 @enderror">{{ old('termination_terms') }}</textarea>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between">
                <a href="{{ route('facility.contracts.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg flex items-center space-x-2 space-x-reverse transition-colors">
