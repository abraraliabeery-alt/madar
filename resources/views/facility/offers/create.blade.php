...
@section('title', 'إضافة خطة إيجار')

@section('content')
<div class="w-full px-4 my-6">
    <div class="bg-white rounded-lg shadow-lg">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-2xl font-bold text-gray-800">إضافة خطة إيجار</h3>
        ...
        <form method="POST" action="{{ route('facility.offers.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="auto_renew" id="auto_renew" class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded" value="1" {{ old('auto_renew') ? 'checked' : '' }}>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between">
                <a href="{{ route('facility.offers.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg flex items-center space-x-2 space-x-reverse transition-colors">
