...
<div class="w-full px-4 my-6">
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('facility.invoices.store') }}" id="invoiceForm" class="p-6">
            @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <select name="invoice_type" id="invoice_type" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('invoice_type') border-red-500 @enderror" required>
                            ...
                            @foreach($invoiceTypes as $value => $label)
                                <option value="{{ $value }}" {{ old('invoice_type') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="payment_terms" 
                                  id="payment_terms" 
                                  rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('payment_terms') border-red-500 @enderror">{{ old('payment_terms') }}</textarea>
                        @error('payment_terms')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="notes" 
                                  id="notes" 
                                  rows="3"
                                  class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
