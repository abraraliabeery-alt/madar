...
<div class="container mx-auto px-4 my-10">
    <div class="bg-white rounded-lg shadow-lg">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 rounded-t-lg flex justify-between items-center">
            <h3 class="text-xl font-semibold text-gray-800">ميزان المراجعة</h3>
            <div class="flex space-x-2 rtl:space-x-reverse">
                <a href="{{ route('facility.accounting.reports.export-trial-balance', request()->query()) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center space-x-2 rtl:space-x-reverse transition-colors">
