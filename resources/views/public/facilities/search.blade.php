...
@section('title', 'البحث في المنشآت')
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">نتائج البحث</h1>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $facilities->total() }} منشأة وجدت</p>
                    </div>
                </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                <div class="bg-white rounded-lg shadow-md p-8">
                    ...
                    <p class="text-gray-600 mb-6">لم نتمكن من العثور على منشآت تطابق "{{ $searchTerm }}"</p>
                    <div class="space-y-3">
                        <p class="text-sm text-gray-500">جرب:</p>
                        <ul class="text-sm text-gray-500 space-y-1">
                            <li>• التأكد من صحة الكلمات المفتاحية</li>
                            <li>• استخدام كلمات مختلفة</li>
                            <li>• البحث بكلمة واحدة فقط</li>
                        </ul>
                    </div>
    ...
    <div class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">نصائح للبحث</h2>
                <p class="text-lg text-gray-600">كيفية الحصول على أفضل النتائج</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">استخدم كلمات مفتاحية</h3>
                    <p class="text-gray-600">ابحث بالاسم أو الموقع أو نوع الخدمة</p>
                </div>
                <div class="text-center">
                    <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-filter text-green-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">استخدم الفلاتر</h3>
                    <p class="text-gray-600">قم بتصفية النتائج حسب الفئة والموقع</p>
                </div>
                <div class="text-center">
                    <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-star text-blue-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">ابحث في المميزة</h3>
                    <p class="text-gray-600">المنشآت المميزة تقدم أفضل الخدمات</p>
                </div>
            </div>
        </div>
    </div>
