...
@section('title', 'المنشآت - ' . $category->name)
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">المنشآت - {{ $category->name }}</h1>
                <p class="text-xl text-primary-100 max-w-3xl mx-auto">
                    اكتشف أفضل المنشآت العقارية في فئة {{ $category->name }}
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $facilities->total() }} منشأة متاحة</p>
                    </div>
                </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                <div class="bg-white rounded-lg shadow-md p-8">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">لا توجد منشآت</h3>
                    <p class="text-gray-600 mb-6">لا توجد منشآت متاحة في فئة {{ $category->name }} حالياً.</p>
        ...
        <div class="bg-white py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">عن فئة {{ $category->name }}</h2>
    ...
    <div class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">فئات أخرى</h2>
                <p class="text-lg text-gray-600">تصفح المنشآت في فئات أخرى</p>
            </div>
                    ...
                    @if($relatedCategory->id !== $category->id)
                        <a href="{{ route('public.facilities.by-category', $relatedCategory) }}"
                           class="bg-white rounded-lg p-6 text-center hover:bg-primary-50 transition-colors shadow-md">
                            ...
                            <p class="text-gray-600 text-sm">{{ $relatedCategory->facilities_count ?? 0 }} منشأة</p>
                        </a>
                    @endif
                @endforeach
            </div>
