    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-bold mb-6">خريطة المنشآت</h1>
                <p class="text-xl text-primary-100 max-w-3xl mx-auto">
                    اكتشف المنشآت العقارية على الخريطة
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="lg:col-span-3">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900">خريطة المنشآت</h2>
                        <div class="flex items-center space-x-4 space-x-reverse">
                            <span class="text-sm text-gray-600">{{ $facilities->count() }} منشأة</span>
                            <button id="locateMe" class="bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-700 transition-colors">
                                <i class="fas fa-location-arrow ml-2"></i>موقعي
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="map" class="w-full h-96 bg-gray-200 rounded-lg flex items-center justify-center">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">خريطة تفاعلية للمنشآت</p>
                            <p class="text-sm text-gray-500 mt-2">سيتم إضافة الخريطة قريباً</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-600">لا توجد منشآت متاحة على الخريطة</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">مميزات الخريطة</h2>
                <p class="text-lg text-gray-600">اكتشف المنشآت بسهولة</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">البحث بالموقع</h3>
                    <p class="text-gray-600">ابحث عن المنشآت القريبة من موقعك</p>
                </div>
                <div class="text-center">
                    <div class="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-route text-green-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">الطرق والمسارات</h3>
                    <p class="text-gray-600">احصل على أفضل الطرق للوصول</p>
                </div>
                <div class="text-center">
                    <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-info-circle text-blue-600 text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">معلومات مفصلة</h3>
                    <p class="text-gray-600">عرض تفاصيل كل منشأة على الخريطة</p>
                </div>
            </div>
        </div>
    </div>
    ...
    document.getElementById('locateMe').addEventListener('click', function() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                alert('تعذر تحديد موقعك. يرجى المحاولة مرة أخرى.');
            });
        } else {
