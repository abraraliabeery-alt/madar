...
return [
    ...
    */
    ...
    'notifications' => [
        ...
        'subtitle' => 'ابق على اطلاع بآخر التحديثات',
        'total_notifications' => 'إجمالي الإشعارات',
        'settings' => 'الإعدادات',
        'new_notification' => 'إشعار جديد',
        'booking_number' => 'رقم الحجز',
        'product' => 'المنتج',
        'status_change_from' => 'تغيير الحالة من',
        'status_change_to' => 'إلى',
        'new' => 'جديد',
    ],

    'notification_settings' => [
        'title' => 'إعدادات الإشعارات',
        'subtitle' => 'تحكم في كيفية استلام الإشعارات',
        ...
        'push_notifications_desc' => 'استلام الإشعارات الفورية',
        'notification_types' => 'أنواع الإشعارات',
        'booking_notifications' => 'إشعارات الحجوزات',
        'booking_notifications_desc' => 'إشعارات حول حالة الحجوزات',
        'product_notifications' => 'إشعارات المنتجات',
        'product_notifications_desc' => 'إشعارات حول المنتجات الجديدة والتحديثات',
        'status_notifications' => 'إشعارات التغييرات',
        'status_notifications_desc' => 'إشعارات حول تغييرات الحالة',
        'frequency_settings' => 'إعدادات التكرار',
        'frequency_label' => 'تكرار الإشعارات:',
        'frequency' => [
            'immediate' => 'فوري',
            'hourly' => 'كل ساعة',
            'daily' => 'يومي',
        ...
        'preview_title' => 'معاينة الإشعارات',
        'preview' => [
            'booking_created' => 'تم إنشاء حجز جديد',
            '5_minutes_ago' => 'منذ 5 دقائق',
            'new_product_added' => 'تم إضافة منتج جديد',
