...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'كلمة المرور المحددة ظهرت في تسريب للبيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'sale_offer.price' => 'سعر البيع',
        'rent_offer.price' => 'سعر الإيجار',
        'rent_offer.period' => 'فترة الإيجار',
        'rent_offer.deposit' => 'التأمين',
        'rent_offer.valid_from' => 'تاريخ بدء الإيجار',
        'rent_offer.valid_to' => 'تاريخ نهاية الإيجار',
        'owner_user_id' => 'المالك',
        'seller_user_id' => 'المسؤول',
        'is_featured' => 'مميز',
        'is_verified' => 'موثق',
        'attributes' => 'الخصائص',
        'attributes.*.value' => 'قيمة الخاصية',
        'attributes.*.attribute_id' => 'الخاصية',
        'features' => 'المميزات',
        'features.*' => 'الميزة',
    ],
